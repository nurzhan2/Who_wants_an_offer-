...
class JSearchSource(BaseSource):
    ...
    Limits: 100 requests per UTC day, five per second, ten postings per page,
    and every page costs one request. The daily count resets at midnight UTC and
    is kept in ``source_quota``; when it is spent the source reports itself
    ...
    def _headers(self) -> dict[str, str]:
        ...
        key = settings.source_credentials.get("jsearch.rapidapi_key")
