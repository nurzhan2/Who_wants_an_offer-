...
from app.db.enums import DocumentKind
...
async def list_rules() -> list[str]:
    ...
    A list of sentences rather than a rule model, because until the workshop
    lands there is nothing to edit: these are the built-in rules, and the screen
    that shows them is explaining a refusal rather than offering a form.
    """
    return list(rules.describe())
