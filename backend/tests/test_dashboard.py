...
from app.db.enums import ApplicationStatus, MatchBucket, PipelineRunStatus
...
async def test_the_dashboard_has_no_way_to_send_an_application(async_client: AsyncClient) -> None:
    ...
    but a document — and the one that does is the letter generator.
    """
    ...
    assert writing == {"/api/v1/documents/letters"}
